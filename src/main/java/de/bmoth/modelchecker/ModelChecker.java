...
public class ModelChecker {
    ...
    private ModelCheckingResult doModelCheck() {
        ...
        Set<Model> models = finder.findSolutions(Preferences.getIntPreference(Preferences.IntPreference.MAX_INITIAL_STATE));
        ...
        while (!queue.isEmpty()) {
            ...
            for (BoolExpr currentOperationConstraint : operationConstraints) {
                ...
                models = finder.findSolutions(Preferences.getIntPreference(Preferences.IntPreference.MAX_TRANSITIONS));
                for (Model model : models) {
