...
public class SolutionFinderTest extends TestUsingZ3 {
    ...
    public void testSolutionFinderNATUpperFail() {
        String maxInt = String.valueOf(Preferences.getIntPreference(Preferences.IntPreference.MAX_INT));
    ...
    public void testSolutionFinderNATUpper() {
        String oneBelowMaxInt = String.valueOf(Preferences.getIntPreference(Preferences.IntPreference.MAX_INT) - 1);
